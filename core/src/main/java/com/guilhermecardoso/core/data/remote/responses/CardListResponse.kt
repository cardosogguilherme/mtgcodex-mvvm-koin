...
data class CardListResponse(
    ...
    @SerializedName("colors") val colors: List<String> = listOf(),
    @SerializedName("digital") val digital: Boolean,
    @SerializedName("edhrec_rank") val edhrecRank: Int = -1,
    ...
    @SerializedName("illustration_id") val illustrationId: String? = null,
    @SerializedName("image_uris") val imageUris: ImageUris? = null,
    @SerializedName("lang") val lang: String,
    @SerializedName("layout") val layout: String,
    @SerializedName("legalities") val legalities: Legalities,
    @SerializedName("mana_cost") val manaCost: String? = null,
    @SerializedName("multiverse_ids") val multiverseIds: List<Int> = listOf(),
    @SerializedName("name") val name: String,
    @SerializedName("nonfoil") val nonfoil: Boolean,
    @SerializedName("oracle_id") val oracleId: String,
    @SerializedName("oracle_text") val oracleText: String? = null,
